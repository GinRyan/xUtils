...
class HttpMultipart {
     ...
     * is of a streaming com.haier.staff.client.entity of unknown length the total length is also unknown.
     * <p/>
     * This method buffers only a small amount of data in order to determine the
     * total length of the entire com.haier.staff.client.entity. The content of individual parts is not
     * buffered.
     *
     * @return total length of the multipart com.haier.staff.client.entity if known, <code>-1</code>
     *         otherwise.
     */
