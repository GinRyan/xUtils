...
/**
 * Multipart/form coded HTTP com.haier.staff.client.entity consisting of multiple body parts.
 *
 * @since 4.0
 */
    ...
    public void consumeContent()
        ...
        if (isStreaming()) {
            throw new UnsupportedOperationException(
                    "Streaming com.haier.staff.client.entity does not implement #consumeContent()");
        }
    }

    public InputStream getContent() throws IOException, UnsupportedOperationException {
        throw new UnsupportedOperationException(
                "Multipart form com.haier.staff.client.entity does not implement #getContent()");
    }
